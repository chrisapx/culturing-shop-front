...
const LiteraryPage: React.FC = () => {
  ...
  useEffect(() => {
    const handleFetch = async () => {
      const ps = await getProductsByCategory("literary");
      setProducts(ps);
    }
  ...
  return (
    <Layout>
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-3">Literary Collection</h1>
        <p className="text-[#5fa9af] mb-6">Literary collection featuring a curated selection of books and literature-related merchandise.</p>
